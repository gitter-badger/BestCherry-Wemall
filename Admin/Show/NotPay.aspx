<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true" CodeBehind="NotPay.aspx.cs" Inherits="Admin.Show.NotPay" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">未付款订单</strong> / <small>Table</small></div>
    </div>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("mobile") %></td>
                            <td><%#Eval("RECEIVER_DISTRICT") %><%#Eval("ADDRESS") %></td>
