<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true" CodeBehind="Poll.aspx.cs" Inherits="Admin.Show.Poll" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">投票商品活动</strong> / <small>Table</small></div>
    </div>
        ...
        <div class="am-g">
            ...
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                    <a href="PollAdd.aspx" class="am-btn am-btn-default"><span class="am-icon-plus"></span>新增</a>
