...
namespace Web.ICBCMethod
{
    public class MobileICBC
    {
        private string _orderPostUrl = "https://mywap2.icbc.com.cn/ICBCWAPBank/servlet/ICBCWAPEBizServlet";
        private string _interfaceName = "ICBC_WAPB_B2C";
        private string _interfaceVersion = "1.0.0.6";
        //1：工行iPhone客户端版
        //2：工行Android客户端版
        //21：工行移动生活版（iPhone）
        //22：工行移动生活版（Android）
        //0：HTML版（只支持iPhone、Android的webkit核心浏览器）
        private string _clienttype = "0";
        ...
        /// 商户代码
        /// </summary>
        private string _merID = "1001EC24964823";
        /// <summary>
        /// 商户账号
        /// </summary>
        private string _merAcct = "1001324819006502285";
        /// <summary>
        /// 检验联名标志
        ...
        /// </summary>
        private string _merReference = System.Configuration.ConfigurationSettings.AppSettings["WebUrl"];

        private string _merIP = System.Configuration.ConfigurationSettings.AppSettings["WebIP"];
