...
namespace Web.UNIONCom.unionpay.sdk
{
    ...
    public class CertUtil
    {
        ...
        public static RSACryptoServiceProvider GetSignProviderFromPfx()
        {
            ...
            X509Certificate2 pc = new X509Certificate2(SDKConfig.SignCertPath, SDKConfig.SignCertPwd);
        ...
        public static RSACryptoServiceProvider Test()
        {
            //
            X509Certificate2 pc = new X509Certificate2("d:\\certs\\503.cer");
           return (RSACryptoServiceProvider)pc.PublicKey.Key;
