<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuthFinish.aspx.cs" Inherits="Web.UNIONMethod.AuthFinish" %>
...
<% 
    ...
    param["backUrl"] = "http://localhost:8080/upacp_sdk_net/demo/utf8/FrontRcvResponse.aspx";//M商户根据自己需求自己填写 路径
    ...
    //预授权撤销的订单号，由商户生成
    param["orderId"] = orderID;//M默认为当前日期时分秒

    //原始预授权交易的queryId
    param["origQryId"] = "201303071540145467132";//M
