<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuthUndo.aspx.cs" Inherits="Web.UNIONMethod.AuthUndo" %>
...
<% 
    ...
    param["backUrl"] = "http://localhost:8080/upacp_sdk_net/demo/utf8/FrontRcvResponse.aspx";//M商户可根据自己需求定义后台地址
