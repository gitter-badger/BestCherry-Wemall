<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consume.aspx.cs" Inherits="Web.UNIONMethod.Consume" %>
...
<% 
   ...
   // param["backUrl"] = "";//M
    ...
    param["merId"] = "898111448160302";//  商户在银联开通的商户号
    ...
    //list.Add("customerInfo01", "11");
    //list.Add("customerInfo02", "222");
    //list.Add("customerInfo03", "11");
    //list.Add("customerInfo04", "4213490012227892");
    //list.Add("customerInfo05", "");
    //list.Add("customerInfo06", "");
    //list.Add("customerInfo07", "");
    //list.Add("customerInfo08", "");

    //param["customerInfo"] = SDKUtil.generateCustomerInfo(list, "4213490012227892", "utf-8", true);
