<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryOpenStatus.aspx.cs" Inherits="Web.UNIONMethod.QueryOpenStatus" %>
...
<% 
  ...
  //  param["signature"] = "";//M
    ...
    param["bizType"] = "000301";//M 认证支付2.0
   ...
   // param["accType"] = "accType";//O
    ...
    //　后台交易时必送，前台交易时选送
    param["accNo"] = "6216261000000000018";//C
    ...
    SDKUtil.Sign(param, Encoding.UTF8);//设置签名
    ...
    if (status == 200)
    {
        ...
        string activateStatus = resData["activateStatus"];//0：未开通业务1：已开通银联全渠道支付2：已开通小额临时支付3：评级开通
